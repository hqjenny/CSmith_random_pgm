 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 18021.c
 * Seed:      1888576819
 */
...
static volatile int32_t g_3[8] = {0x876E6BACL,0xF6065797L,0x876E6BACL,0x876E6BACL,0xF6065797L,0x876E6BACL,0x876E6BACL,0xF6065797L};
...
static uint16_t  func_1(void)
{ /* block id: 0 */
    int32_t l_13[7] = {0x15AA9614L,0x15AA9614L,0x15AA9614L,0x15AA9614L,0x15AA9614L,0x15AA9614L,0x15AA9614L};
    int i;
    for (g_5 = 0; (g_5 == 8); g_5 = safe_add_func_int8_t_s_s(g_5, 1))
    { /* block id: 3 */
        for (g_8 = 0; (g_8 < (-9)); g_8--)
        { /* block id: 6 */
            g_3[5] = 0x946507E6L;
        }
        g_3[5] = (l_13[0] == (g_2 != (g_8 & 1L)));
    }
    return l_13[0];
}
