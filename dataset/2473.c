 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 2473.c
 * Seed:      3707703030
 */
...
static volatile int32_t g_3 = 0x24F01C08L;/* VOLATILE GLOBAL g_3 */
static volatile int32_t g_4 = 4L;/* VOLATILE GLOBAL g_4 */
static int32_t g_5 = 0L;
static int16_t g_12 = 0x2C25L;
...
{ /* block id: 0 */
    uint16_t l_10 = 6UL;
    for (g_5 = 0; (g_5 < (-11)); g_5 = safe_sub_func_uint16_t_u_u(g_5, 5))
    { /* block id: 3 */
        int16_t l_11 = 0L;
        g_12 &= (g_3 > (safe_add_func_int32_t_s_s(l_10, l_11)));
    }
    return l_10;
}
