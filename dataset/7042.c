 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 7042.c
 * Seed:      1679086008
 */
...
static volatile int32_t g_5 = 0x7A7C2039L;/* VOLATILE GLOBAL g_5 */
static int32_t g_6 = (-4L);
static volatile int32_t g_9 = 0xBA095A97L;/* VOLATILE GLOBAL g_9 */
