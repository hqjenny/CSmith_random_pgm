 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 3592.c
 * Seed:      2630065783
 */
...
static uint32_t g_4[2] = {0xE60B0CEAL,0xE60B0CEAL};
static volatile int32_t g_5 = (-1L);/* VOLATILE GLOBAL g_5 */
static volatile int32_t g_6 = 0xD8D13034L;/* VOLATILE GLOBAL g_6 */
static int32_t g_7 = 0x693E9323L;
static int16_t g_8 = 0xFC4BL;
...
/* ------------------------------------------ */
/* 
 * reads : g_3 g_4 g_7 g_8
 * writes: g_3 g_4 g_7 g_6 g_8 g_5
 */
static int8_t  func_1(void)
{ /* block id: 0 */
    uint16_t l_2[5];
