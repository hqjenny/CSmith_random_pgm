 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 1491.c
 * Seed:      3742899277
 */
...
/* --- GLOBAL VARIABLES --- */
static int32_t g_2 = 0xA8EAC8B1L;
...
/* 
 * reads : g_2 g_5 g_9
 * writes: g_2 g_5 g_9 g_8
 */
static const int16_t  func_1(void)
{ /* block id: 0 */
    for (g_2 = 28; (g_2 > 14); g_2--)
    { /* block id: 3 */
        const uint16_t l_12 = 0xDFD9L;
        g_5 = g_2;
        for (g_5 = (-6); (g_5 >= (-6)); g_5 = safe_add_func_int8_t_s_s(g_5, 7))
        { /* block id: 7 */
