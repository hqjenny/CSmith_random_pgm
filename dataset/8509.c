 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 8509.c
 * Seed:      4168020546
 */
...
/* --- GLOBAL VARIABLES --- */
static uint32_t g_2[4][2][1] = {{{0x020F89B5L},{2UL}},{{2UL},{0x020F89B5L}},{{2UL},{2UL}},{{0x020F89B5L},{2UL}}};
static volatile int32_t g_3 = 1L;/* VOLATILE GLOBAL g_3 */
static int32_t g_4[4] = {(-10L),(-10L),(-10L),(-10L)};
