 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 16261.c
 * Seed:      4270369097
 */
...
static volatile int32_t g_4 = 0x4A025691L;/* VOLATILE GLOBAL g_4 */
static int32_t g_5[3] = {0x36951AD3L,0x36951AD3L,0x36951AD3L};
...
{ /* block id: 0 */
    ...
    for (g_5[0] = 0; (g_5[0] != (-5)); g_5[0] = safe_sub_func_int32_t_s_s(g_5[0], 5))
    { /* block id: 3 */
        return g_3;
    }
    l_10++;
