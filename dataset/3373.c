 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 3373.c
 * Seed:      3508157623
 */
...
static volatile int32_t g_7 = 0x8885C6F1L;/* VOLATILE GLOBAL g_7 */
static int32_t g_8 = 0x06E60B0CL;
...
static int32_t  func_1(void)
{ /* block id: 0 */
    uint32_t l_11[8][2] = {{0x4A20A298L,4294967295UL},{0UL,0UL},{4294967295UL,0x4A20A298L},{6UL,0x4A20A298L},{4294967295UL,0UL},{0UL,4294967295UL},{0x4A20A298L,6UL},{0x4A20A298L,4294967295UL}};
    int i, j;
    for (g_8 = 0; (g_8 != 8); ++g_8)
    { /* block id: 3 */
        g_2 = g_5;
