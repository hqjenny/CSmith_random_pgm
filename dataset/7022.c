 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 7022.c
 * Seed:      371542962
 */
...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_3[8] = {0xFE7D8A87L,0xFE7D8A87L,0xFE7D8A87L,0xFE7D8A87L,0xFE7D8A87L,0xFE7D8A87L,0xFE7D8A87L,0xFE7D8A87L};
static volatile int32_t g_4 = 0x3B9DA4D0L;/* VOLATILE GLOBAL g_4 */
