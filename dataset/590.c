 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 590.c
 * Seed:      4156168185
 */
...
static volatile int32_t g_3 = 0x8261F9C2L;/* VOLATILE GLOBAL g_3 */
static int32_t g_4 = 3L;
static volatile int32_t g_7[1] = {0xD4F2887CL};
...
/* ------------------------------------------ */
/* 
 * reads : g_4 g_9 g_7 g_13 g_3
 * writes: g_4 g_3 g_9 g_13 g_7
 */
static int16_t  func_1(void)
{ /* block id: 0 */
    uint32_t l_16 = 18446744073709551615UL;
    for (g_4 = 15; (g_4 <= 4); g_4 = safe_sub_func_int8_t_s_s(g_4, 1))
    { /* block id: 3 */
        int32_t l_12 = (-6L);
        g_3 = (-9L);
        for (g_9 = 0; (g_9 == 8); ++g_9)
