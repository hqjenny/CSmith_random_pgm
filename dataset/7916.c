 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 7916.c
 * Seed:      288368
 */
...
static uint8_t g_11[3] = {0UL,0UL,0UL};
static uint8_t g_12 = 255UL;
static uint32_t g_13 = 0x5589B583L;
...
static uint32_t  func_1(void)
{ /* block id: 0 */
    const uint8_t l_7 = 0x6FL;
    int32_t l_10 = 0xC5165352L;
    g_12 |= (safe_add_func_int8_t_s_s((safe_add_func_uint16_t_u_u(g_6, 0L)), (((l_7 || (g_6 , func_8(((l_10 = 1UL) , l_7)))) > (-9L)) | (func_8(l_7) & l_7))));
    g_13 = (l_10 = (g_6 > g_12));
    return g_6;
}
