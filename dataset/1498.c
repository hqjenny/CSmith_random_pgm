 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 1498.c
 * Seed:      1133323902
 */
...
{ /* block id: 0 */
    ...
    for (g_4 = (-10); (g_4 <= 18); g_4 = safe_add_func_uint16_t_u_u(g_4, 7))
    { /* block id: 3 */
        uint32_t l_7[5];
        int i;
        for (i = 0; i < 5; i++)
