 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 16818.c
 * Seed:      1918344325
 */
...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_2[6] = {0L,0xBAC64A68L,0L,0L,0xBAC64A68L,0L};
static int32_t g_3 = 0xF0B96CA2L;
static volatile int32_t g_6 = (-1L);/* VOLATILE GLOBAL g_6 */
static int32_t g_7 = 0xC4AB274BL;
...
{ /* block id: 0 */
    ...
    int16_t l_13 = (-7L);
    uint8_t l_14 = 0x17L;
    for (g_3 = 0; (g_3 != 13); g_3 = safe_add_func_uint32_t_u_u(g_3, 7))
    { /* block id: 3 */
    ...
    l_10 = (g_3 = (safe_unary_minus_func_int8_t_s(l_9)));
    for (l_10 = 1; (l_10 >= 24); ++l_10)
    { /* block id: 14 */
        return l_13;
    }
    l_14++;
