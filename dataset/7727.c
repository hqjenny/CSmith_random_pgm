 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 7727.c
 * Seed:      742459958
 */
...
static int16_t  func_1(void)
{ /* block id: 0 */
    for (g_2 = 0; (g_2 >= 10); g_2 = safe_add_func_uint32_t_u_u(g_2, 9))
    { /* block id: 3 */
        uint16_t l_5[5] = {65529UL,65529UL,65529UL,65529UL,65529UL};
        int i;
