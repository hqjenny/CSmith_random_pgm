 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 6221.c
 * Seed:      2545344416
 */
...
static volatile int32_t g_5 = 0x9BEB0647L;/* VOLATILE GLOBAL g_5 */
...
{ /* block id: 0 */
    uint8_t l_13 = 0xA1L;
    int32_t l_16 = 0x100C4307L;
    for (g_6 = 0; (g_6 == 27); g_6++)
    { /* block id: 3 */
        int32_t l_9 = 0xAE77AB39L;
        int32_t l_10 = 6L;
        int32_t l_11 = 0x707DFE4DL;
        int32_t l_12 = (-1L);
        l_13--;
    }
    g_3 = ((g_2 , l_13) == (l_16 <= (65526UL < g_6)));
    return l_16;
}
