 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 13165.c
 * Seed:      1691659916
 */
...
static volatile int32_t g_4 = 0xA1F94964L;/* VOLATILE GLOBAL g_4 */
...
/* ------------------------------------------ */
/* 
 * reads : g_5 g_3 g_4 g_11
 * writes: g_5
 */
static uint32_t  func_1(void)
{ /* block id: 0 */
    int8_t l_2[9];
    int32_t l_8 = 0x4BC662A2L;
    int i;
    for (i = 0; i < 9; i++)
        l_2[i] = 0x19L;
    ...
    { /* block id: 3 */
        int i;
        l_8 = (safe_mul_func_uint8_t_u_u(l_2[(g_5 + 3)], g_3));
    }
    l_8 = (safe_div_func_int32_t_s_s(l_8, l_8));
    l_8 |= (4L != (-7L));
    l_8 = g_4;
    return g_11;
}
