 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 12198.c
 * Seed:      2376045472
 */
...
static int32_t g_4[3][2] = {{(-6L),0x85299DADL},{0x85299DADL,(-6L)},{0x85299DADL,0x85299DADL}};
...
{ /* block id: 0 */
    int8_t l_7 = (-8L);
    for (g_4[1][1] = (-18); (g_4[1][1] < (-19)); g_4[1][1] = safe_sub_func_uint8_t_u_u(g_4[1][1], 1))
    { /* block id: 3 */
        return l_7;
    }
    g_4[1][1] = 1L;
