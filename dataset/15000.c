 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 15000.c
 * Seed:      3128405522
 */
...
static volatile int32_t g_4 = 0x5E7A66FEL;/* VOLATILE GLOBAL g_4 */
static int32_t g_5[1][4] = {{2L,2L,2L,2L}};
...
static int16_t  func_1(void)
{ /* block id: 0 */
    int32_t l_10 = 0x7B568BE1L;
    for (g_5[0][1] = 15; (g_5[0][1] > 25); g_5[0][1] = safe_add_func_uint16_t_u_u(g_5[0][1], 3))
    { /* block id: 3 */
        int32_t l_8 = (-1L);
        return l_8;
    }
