 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 8470.c
 * Seed:      1094972718
 */
...
static int32_t g_6 = 0x9B2CFB63L;
static volatile uint32_t g_10 = 0xCCB63E8EL;/* VOLATILE GLOBAL g_10 */
...
{ /* block id: 0 */
    int32_t l_9 = 1L;
    int8_t l_13 = 0xACL;
    for (g_6 = 0; (g_6 <= 2); g_6 = safe_add_func_uint16_t_u_u(g_6, 2))
    { /* block id: 3 */
        ++g_10;
        if (g_4)
            break;
