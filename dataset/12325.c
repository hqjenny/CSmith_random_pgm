 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 12325.c
 * Seed:      2015954406
 */
...
static volatile int32_t g_7[1] = {(-9L)};
static volatile int32_t g_8 = 0x55B7CEFAL;/* VOLATILE GLOBAL g_8 */
static int32_t g_9 = 0x9AC196A1L;
...
static uint16_t  func_1(void)
{ /* block id: 0 */
    for (g_9 = 0; (g_9 == (-8)); g_9 = safe_sub_func_uint8_t_u_u(g_9, 6))
    { /* block id: 3 */
        g_8 ^= (-10L);
    }
    return g_7[0];
