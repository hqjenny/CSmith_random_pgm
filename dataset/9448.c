 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 9448.c
 * Seed:      3882209800
 */
...
static int32_t g_5[2] = {0x256A9EF7L,0x256A9EF7L};
...
{ /* block id: 0 */
    ...
    g_3 = g_2;
    for (g_5[0] = (-12); (g_5[0] == 6); g_5[0] = safe_add_func_int16_t_s_s(g_5[0], 3))
    { /* block id: 4 */
        uint16_t l_9 = 65535UL;
        const uint8_t l_10[1] = {255UL};
        int i;
        l_9 = l_8;
        g_4 = ((l_10[0] >= 0xCE96B779L) , 0x3C407858L);
        if (g_5[1])
            break;
    }
    return l_11;
