 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 15765.c
 * Seed:      210331722
 */
...
static volatile int32_t g_9 = 0x3E31551DL;/* VOLATILE GLOBAL g_9 */
static volatile uint8_t g_13[3][2] = {{1UL,0xADL},{0xADL,1UL},{0xADL,0xADL}};
...
static const int16_t  func_1(void)
{ /* block id: 0 */
    int32_t l_8 = 0xB4EBB0CBL;
    int32_t l_10 = (-10L);
    int32_t l_11 = (-1L);
    int32_t l_12 = 0x0A233712L;
    uint8_t l_16 = 0xD2L;
