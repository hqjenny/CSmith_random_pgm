 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 9472.c
 * Seed:      3969767431
 */
...
static volatile int32_t g_4[3] = {(-8L),(-8L),(-8L)};
...
{ /* block id: 0 */
    ...
    int32_t l_9 = 0x82A10AA4L;
    int i;
    for (g_3 = 0; (g_3 <= 3); g_3 += 1)
    { /* block id: 3 */
        uint32_t l_6 = 0xABE8F210L;
