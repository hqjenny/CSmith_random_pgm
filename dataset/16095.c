 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 16095.c
 * Seed:      4239246873
 */
...
{ /* block id: 0 */
    ...
    { /* block id: 3 */
        int16_t l_5 = 0x446DL;
        uint32_t l_9 = 0x5B7D8CF4L;
        l_5 = g_2;
        g_10 ^= (safe_lshift_func_int8_t_s_s((g_8[6] = (g_2 || 0x4DC9ED9BL)), ((g_2 <= g_2) , l_9)));
    }
    l_11 &= g_2;
    return l_11;
}
