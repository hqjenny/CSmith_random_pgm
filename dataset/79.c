 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 79.c
 * Seed:      4005699895
 */
...
/* --- GLOBAL VARIABLES --- */
static uint32_t g_2[2] = {4294967293UL,4294967293UL};
static int32_t g_3 = 0x93905C80L;
static volatile uint8_t g_4 = 1UL;/* VOLATILE GLOBAL g_4 */
static volatile int8_t g_7 = 0xF6L;/* VOLATILE GLOBAL g_7 */
static uint16_t g_8[3] = {0x034DL,0x034DL,0x034DL};
