 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 2203.c
 * Seed:      4214820092
 */
...
/* --- GLOBAL VARIABLES --- */
static uint8_t g_2[6] = {9UL,0xA0L,9UL,9UL,0xA0L,9UL};
...
static uint32_t  func_1(void)
{ /* block id: 0 */
    uint32_t l_7 = 0xF3C34EEAL;
    int32_t l_10 = 0x8591B68DL;
    int32_t l_11 = 0xFDA7EF5DL;
    ++g_2[2];
    ...
    l_7 = 1L;
    g_5 = ((safe_rshift_func_int8_t_s_s(g_2[4], 5)) == (l_10 != (l_11 |= g_6)));
    return g_6;
}
