 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 11070.c
 * Seed:      3741676359
 */
...
static uint32_t g_12[10] = {6UL,6UL,6UL,6UL,6UL,6UL,6UL,6UL,6UL,6UL};
...
{ /* block id: 0 */
    ...
    for (i = 0; i < 1; i++)
        l_7[i] = 1UL;
    for (g_3 = 0; (g_3 == (-1)); g_3 = safe_sub_func_int8_t_s_s(g_3, 4))
    { /* block id: 3 */
        if ((l_6 ^= 0x00D4E793L))
        { /* block id: 5 */
            l_7[0]++;
        ...
        { /* block id: 7 */
            int8_t l_10 = 7L;
            int32_t l_13 = 0xC2A82A10L;
            l_13 = (g_12[5] = (g_11 = l_10));
            if (g_3)
                break;
        }
    }
