 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 9326.c
 * Seed:      2565571912
 */
...
/* --- GLOBAL VARIABLES --- */
static uint8_t g_2[7] = {0xCFL,0xCFL,0xCFL,0xCFL,0xCFL,0xCFL,0xCFL};
...
static int32_t g_6 = 0x08F8256AL;
