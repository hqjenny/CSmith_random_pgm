 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 14596.c
 * Seed:      3787054158
 */
...
static volatile int32_t g_5 = 0x8E56F9B2L;/* VOLATILE GLOBAL g_5 */
...
static int16_t  func_1(void)
{ /* block id: 0 */
    uint16_t l_13[4] = {8UL,8UL,8UL,8UL};
    uint8_t l_15 = 1UL;
    int i;
    for (g_6 = 0; (g_6 != (-30)); --g_6)
    { /* block id: 3 */
        for (g_10 = 8; (g_10 < 24); g_10++)
        { /* block id: 6 */
            uint32_t l_14[6] = {0x94F934F5L,0x94F934F5L,6UL,0x94F934F5L,0x94F934F5L,6UL};
            int i;
            g_2 = (l_14[5] &= l_13[0]);
        }
        return l_15;
