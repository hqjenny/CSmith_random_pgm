 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 17374.c
 * Seed:      3934426791
 */
...
static int16_t g_5[7] = {0L,0L,0L,0L,0L,0L,0L};
static volatile uint8_t g_6 = 0xF2L;/* VOLATILE GLOBAL g_6 */
