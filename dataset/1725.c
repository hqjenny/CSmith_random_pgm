 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 1725.c
 * Seed:      1058885388
 */
...
/* 
 * reads : g_4 g_8
 * writes: g_4 g_3 g_8 g_7
 */
static uint16_t  func_1(void)
{ /* block id: 0 */
    uint32_t l_2[9] = {0x1928C176L,0x1928C176L,0x1928C176L,0x1928C176L,0x1928C176L,0x1928C176L,0x1928C176L,0x1928C176L,0x1928C176L};
    int i;
lbl_10:
    ...
    for (g_4 = 0; (g_4 >= 8); ++g_4)
    { /* block id: 9 */
        int32_t l_9 = 0x29EDCA8FL;
        for (g_8[0] = 0; (g_8[0] <= 8); g_8[0] += 1)
        { /* block id: 12 */
            int i;
            g_7 = (l_2[g_8[0]] >= (l_9 >= g_8[0]));
        }
    }
    if (g_4)
        goto lbl_10;
