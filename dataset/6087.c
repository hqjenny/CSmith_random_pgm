 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 6087.c
 * Seed:      3482652230
 */
...
static int32_t g_3 = 0x9AC78948L;
static volatile int32_t g_7 = 0x7CEFA9D1L;/* VOLATILE GLOBAL g_7 */
...
{ /* block id: 0 */
    ...
    { /* block id: 3 */
        ...
        { /* block id: 6 */
            int32_t l_11 = 0x819570A5L;
            int i;
            l_11 |= ((safe_mul_func_uint8_t_u_u(l_6[g_8], l_6[g_8])) != g_7);
            l_12 = g_3;
        }
    }
    return g_8;
