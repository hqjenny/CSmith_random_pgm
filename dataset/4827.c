 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 4827.c
 * Seed:      3133479496
 */
...
static int32_t g_4[4][2][2] = {{{7L,0x96DD1E1EL},{0x96DD1E1EL,7L}},{{0x96DD1E1EL,0x96DD1E1EL},{7L,0x96DD1E1EL}},{{0x96DD1E1EL,7L},{0x96DD1E1EL,0x96DD1E1EL}},{{7L,0x96DD1E1EL},{0x96DD1E1EL,7L}}};
...
{ /* block id: 0 */
    ...
    for (g_4[0][0][1] = 0; (g_4[0][0][1] != 4); ++g_4[0][0][1])
    { /* block id: 3 */
        uint8_t l_7 = 0UL;
        if (l_7)
            break;
