 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 2704.c
 * Seed:      121309774
 */
...
static volatile int32_t g_4 = 0xCD8C45CDL;/* VOLATILE GLOBAL g_4 */
static volatile int32_t g_5 = 0xE56F9B2CL;/* VOLATILE GLOBAL g_5 */
static volatile int32_t g_6 = (-1L);/* VOLATILE GLOBAL g_6 */
static volatile int32_t g_7[9] = {0L,0L,0L,0L,0L,0L,0L,0L,0L};
static int32_t g_8[1] = {0x5DE05DAEL};
