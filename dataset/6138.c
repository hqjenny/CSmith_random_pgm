 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 6138.c
 * Seed:      1863139401
 */
...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3[8] = {5L,0x0256915AL,5L,5L,0x0256915AL,5L,5L,0x0256915AL};
static volatile int32_t g_4 = (-1L);/* VOLATILE GLOBAL g_4 */
static int32_t g_5 = 0x6E5C7A00L;
...
static uint32_t  func_1(void)
{ /* block id: 0 */
    int8_t l_2[7][1] = {{0x68L},{(-1L)},{0x68L},{(-1L)},{0x68L},{(-1L)},{0x68L}};
    int i, j;
