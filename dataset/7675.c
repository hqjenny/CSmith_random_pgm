 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 7675.c
 * Seed:      3364352031
 */
...
static int32_t g_6[3] = {0x35F394A2L,0x35F394A2L,0x35F394A2L};
...
{ /* block id: 0 */
    ...
    { /* block id: 3 */
        for (g_6[1] = 24; (g_6[1] <= 8); --g_6[1])
        { /* block id: 6 */
            uint32_t l_9 = 0xD72D7671L;
            ++l_9;
            g_2 = l_9;
        }
    }
