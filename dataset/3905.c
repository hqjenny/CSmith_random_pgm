 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 3905.c
 * Seed:      919797171
 */
...
static volatile uint32_t g_10 = 0x6141E4F1L;/* VOLATILE GLOBAL g_10 */
