 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 12762.c
 * Seed:      256088542
 */
...
static volatile int32_t g_3[2][1] = {{0x56834504L},{0x56834504L}};
static volatile int32_t g_4 = (-1L);/* VOLATILE GLOBAL g_4 */
static volatile int32_t g_5 = 0x473EB905L;/* VOLATILE GLOBAL g_5 */
static int32_t g_6[1][10] = {{0L,(-1L),(-1L),0L,(-1L),(-1L),0L,(-1L),(-1L),0L}};
...
{ /* block id: 0 */
    uint8_t l_9 = 0x69L;
    int32_t l_14 = 9L;
    for (g_6[0][2] = (-21); (g_6[0][2] == 8); ++g_6[0][2])
    { /* block id: 3 */
        int16_t l_12 = 2L;
        int32_t l_13 = 1L;
        l_9 &= 1L;
