 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 15259.c
 * Seed:      3258939323
 */
...
/* ------------------------------------------ */
/* 
 * reads : g_2 g_7 g_8 g_6
 * writes: g_2 g_7 g_8 g_6
 */
static int8_t  func_1(void)
{ /* block id: 0 */
    for (g_2 = 0; (g_2 < 14); g_2 = safe_add_func_int32_t_s_s(g_2, 3))
    { /* block id: 3 */
        int16_t l_5[10] = {0xAE8CL,(-1L),0xAE8CL,0xAE8CL,(-1L),0xAE8CL,0xAE8CL,(-1L),0xAE8CL,0xAE8CL};
        int i;
