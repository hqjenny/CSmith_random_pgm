 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 1114.c
 * Seed:      1029335736
 */
...
static volatile int32_t g_3[2][4][2] = {{{3L,(-7L)},{(-5L),(-5L)},{(-7L),3L},{0x8070ADE2L,3L}},{{(-7L),(-5L)},{(-5L),(-7L)},{3L,0x8070ADE2L},{3L,(-7L)}}};
static volatile int32_t g_4 = 0xB666A756L;/* VOLATILE GLOBAL g_4 */
