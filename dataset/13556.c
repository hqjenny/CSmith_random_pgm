 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 13556.c
 * Seed:      1428529310
 */
...
static int32_t g_7 = 0x473EB905L;
static int32_t g_10[5] = {0x526D2E85L,0x526D2E85L,0x526D2E85L,0x526D2E85L,0x526D2E85L};
...
static uint32_t  func_1(void)
{ /* block id: 0 */
    int32_t l_13 = 0x62513244L;
    for (g_3 = 0; (g_3 > 12); ++g_3)
    { /* block id: 3 */
        uint16_t l_14[4] = {1UL,1UL,1UL,1UL};
        int i;
        for (g_7 = 14; (g_7 > 23); ++g_7)
        { /* block id: 6 */
            for (g_10[1] = 0; (g_10[1] <= 25); g_10[1] = safe_add_func_int32_t_s_s(g_10[1], 4))
            { /* block id: 9 */
                return l_13;
            }
            return l_13;
