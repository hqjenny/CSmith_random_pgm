 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 2289.c
 * Seed:      3012384190
 */
...
static volatile int32_t g_5[5][2] = {{1L,0x98311173L},{7L,1L},{(-3L),(-3L)},{(-3L),1L},{7L,0x98311173L}};
static volatile int32_t g_6[3][2] = {{0x68D526D2L,0x68D526D2L},{(-1L),0x68D526D2L},{0x68D526D2L,(-1L)}};
static int32_t g_7[2][3] = {{6L,6L,6L},{(-1L),(-1L),(-1L)}};
...
{ /* block id: 0 */
    ...
    for (i = 0; i < 5; i++)
        l_2[i] = 0xE3556834L;
    for (g_7[1][0] = 0; (g_7[1][0] <= 4); g_7[1][0] += 1)
    { /* block id: 3 */
        int i;
        return l_2[g_7[1][0]];
    }
