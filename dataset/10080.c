 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 10080.c
 * Seed:      3425150676
 */
...
{ /* block id: 0 */
    ...
    { /* block id: 3 */
        int16_t l_9 = 0x1188L;
        int32_t l_10 = 9L;
        l_10 = (l_2[0][0] || ((safe_add_func_int8_t_s_s((safe_rshift_func_uint16_t_u_u(g_3[1], l_9)), l_9)) , 4294967295UL));
        return g_3[0];
    }
    return l_2[0][2];
}
