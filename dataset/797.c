 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 797.c
 * Seed:      1574600390
 */
...
static volatile int32_t g_6[4] = {0x7E8B72FDL,0x7E8B72FDL,0x7E8B72FDL,0x7E8B72FDL};
