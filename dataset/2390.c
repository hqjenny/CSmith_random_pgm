 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 2390.c
 * Seed:      3728238057
 */
...
static int32_t g_9[9] = {0x166941FCL,0x166941FCL,0x166941FCL,0x166941FCL,0x166941FCL,0x166941FCL,0x166941FCL,0x166941FCL,0x166941FCL};
...
{ /* block id: 0 */
    ...
    l_6 = (safe_rshift_func_int16_t_s_s((((!0xD386L) != (-1L)) , (-1L)), l_5));
    --g_10;
    return g_8;
}
