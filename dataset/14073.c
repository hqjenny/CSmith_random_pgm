 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 14073.c
 * Seed:      2311030912
 */
...
static uint8_t g_6[6] = {0xB3L,0xB3L,0xB3L,0xB3L,0xB3L,0xB3L};
