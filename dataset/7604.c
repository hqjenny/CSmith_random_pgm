 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 7604.c
 * Seed:      4153813492
 */
...
static uint8_t g_14[10] = {0xAAL,0xAAL,0xAAL,0xAAL,0xAAL,0xAAL,0xAAL,0xAAL,0xAAL,0xAAL};
...
static uint8_t  func_1(void)
{ /* block id: 0 */
    uint32_t l_5 = 0xA8E97EEDL;
    g_14[3] = (safe_mod_func_uint32_t_u_u((~l_5), (safe_mul_func_uint16_t_u_u((0x5A9C4C8DL & g_8), func_9(l_5, g_12)))));
    return l_5;
}
