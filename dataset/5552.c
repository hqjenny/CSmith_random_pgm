 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 5552.c
 * Seed:      353987197
 */
...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_2 = 0x39B642C7L;/* VOLATILE GLOBAL g_2 */
static int32_t g_3[4] = {(-6L),(-6L),(-6L),(-6L)};
