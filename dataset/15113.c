 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 15113.c
 * Seed:      668782441
 */
...
static int32_t g_6[10] = {0x5A136951L,0x5A136951L,0x5A136951L,0x5A136951L,0x5A136951L,0x5A136951L,0x5A136951L,0x5A136951L,0x5A136951L,0x5A136951L};
...
{ /* block id: 0 */
    uint8_t l_9 = 0x54L;
    uint16_t l_10 = 0xC74AL;
    int32_t l_11 = 0x276B87D0L;
    for (g_6[0] = 0; (g_6[0] > (-30)); g_6[0] = safe_sub_func_int8_t_s_s(g_6[0], 5))
    { /* block id: 3 */
        return g_4;
    }
    l_11 ^= (l_10 = l_9);
