 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 11195.c
 * Seed:      842398092
 */
...
static volatile int16_t g_4 = 0x64A5L;/* VOLATILE GLOBAL g_4 */
static volatile int32_t g_5 = 1L;/* VOLATILE GLOBAL g_5 */
static int8_t g_6[1][1] = {{0x49L}};
