 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 13879.c
 * Seed:      2921581911
 */
...
static int32_t g_5 = 0x85C6F1BFL;
...
{ /* block id: 0 */
    ...
    for (g_5 = 0; (g_5 > (-14)); g_5 = safe_sub_func_int16_t_s_s(g_5, 1))
    { /* block id: 3 */
        int16_t l_11 = 0L;
        ++g_8;
        ++l_12;
