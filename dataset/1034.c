...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_3 = 0x5AB3E90AL;/* VOLATILE GLOBAL g_3 */
...
static uint32_t  func_1(void)
{ /* block id: 0 */
    int32_t l_2[6] = {0x0647DC4BL,0xBCA63185L,0x0647DC4BL,0x0647DC4BL,0xBCA63185L,0x0647DC4BL};
    int32_t l_8 = 0x0C3414B5L;
    int i;
