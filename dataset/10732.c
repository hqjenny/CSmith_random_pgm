 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 10732.c
 * Seed:      197349854
 */
...
static volatile int32_t g_4 = 0x34504CD4L;/* VOLATILE GLOBAL g_4 */
static volatile int32_t g_5[2][2] = {{0x06DE713AL,0x06DE713AL},{0x06DE713AL,0x06DE713AL}};
...
static const int32_t  func_1(void)
{ /* block id: 0 */
    for (g_7 = (-1); (g_7 >= (-21)); g_7 = safe_sub_func_uint32_t_u_u(g_7, 8))
    { /* block id: 3 */
        g_6 = 0xE8588D0DL;
    }
    return g_3;
