 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 6933.c
 * Seed:      3773635805
 */
...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_2 = 0x68206240L;/* VOLATILE GLOBAL g_2 */
static volatile int32_t g_3 = 1L;/* VOLATILE GLOBAL g_3 */
static int32_t g_4 = 0x0BB743D8L;
static volatile int32_t g_7[5] = {0x55E00FE1L,0x55E00FE1L,0x55E00FE1L,0x55E00FE1L,0x55E00FE1L};
...
{ /* block id: 0 */
    ...
    { /* block id: 3 */
        ...
        for (g_8 = (-2); (g_8 <= (-20)); --g_8)
        { /* block id: 6 */
            uint32_t l_11 = 0UL;
            return l_11;
        }
        l_15 = (safe_lshift_func_uint8_t_u_s((l_14 < g_4), 3));
    }
    g_8 &= (l_15 = g_7[2]);
    return g_7[2];
}
