 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 1507.c
 * Seed:      2160105039
 */
...
static uint8_t g_7[6][2][1] = {{{0x94L},{1UL}},{{0x94L},{1UL}},{{0x94L},{1UL}},{{0x94L},{1UL}},{{0x94L},{1UL}},{{0x94L},{1UL}}};
