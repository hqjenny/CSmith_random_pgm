 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 7285.c
 * Seed:      2841767969
 */
...
static uint8_t g_6[10] = {249UL,251UL,249UL,249UL,251UL,249UL,249UL,251UL,249UL,249UL};
...
{ /* block id: 0 */
    uint8_t l_8 = 255UL;
    int32_t l_9 = 0x2250DB85L;
    for (g_3 = 0; (g_3 != (-9)); --g_3)
    { /* block id: 3 */
        for (g_7 = 9; (g_7 >= 1); g_7 -= 1)
        { /* block id: 6 */
            int i;
            return g_6[g_7];
        }
