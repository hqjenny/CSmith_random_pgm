 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 1354.c
 * Seed:      1851099793
 */
...
static volatile int32_t g_5[3] = {0x69AD59E5L,0x69AD59E5L,0x69AD59E5L};
static int32_t g_6 = 0x7CA0029BL;
...
{ /* block id: 0 */
    int32_t l_9 = 5L;
    for (g_6 = (-19); (g_6 < (-29)); g_6 = safe_sub_func_int32_t_s_s(g_6, 3))
    { /* block id: 3 */
        return g_2;
    }
    l_9 |= g_2;
