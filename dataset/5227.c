 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 5227.c
 * Seed:      1293707869
 */
...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_2[6] = {3L,0x68206240L,3L,3L,0x68206240L,3L};
static volatile int32_t g_3 = (-3L);/* VOLATILE GLOBAL g_3 */
static int32_t g_4 = 0x6E871D97L;
...
static const uint16_t  func_1(void)
{ /* block id: 0 */
    const int32_t l_11 = 0xBD3AEB59L;
    for (g_4 = 0; (g_4 != 5); g_4++)
    { /* block id: 3 */
        int8_t l_7 = 8L;
        const uint32_t l_10 = 0x96673E7EL;
        l_7 &= 0xC0F8067EL;
        g_2[3] = ((safe_sub_func_uint16_t_u_u(0xB80BL, l_7)) , g_2[5]);
        return l_10;
    }
    g_2[2] = g_2[0];
    return l_11;
