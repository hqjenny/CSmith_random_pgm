 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 11314.c
 * Seed:      3761630854
 */
...
static int32_t g_8 = 0x19AC196AL;
...
{ /* block id: 0 */
    uint16_t l_5[8];
    volatile int32_t l_9 = 0x57688195L;/* VOLATILE GLOBAL l_9 */
    int i;
    for (i = 0; i < 8; i++)
        l_5[i] = 0UL;
