 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 9371.c
 * Seed:      1418899703
 */
...
/* --- GLOBAL VARIABLES --- */
static int16_t g_4[6][2] = {{1L,1L},{1L,1L},{1L,1L},{1L,1L},{1L,1L},{1L,1L}};
static int16_t g_5 = 0L;
static uint32_t g_6 = 0UL;
static uint8_t g_10 = 0xDDL;
