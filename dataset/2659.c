 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 2659.c
 * Seed:      4215773990
 */
...
static int32_t g_4[4] = {0x97A4A12BL,0x97A4A12BL,0x97A4A12BL,0x97A4A12BL};
...
{ /* block id: 0 */
    int16_t l_10 = (-2L);
    for (g_4[0] = 0; (g_4[0] > 29); g_4[0] = safe_add_func_int32_t_s_s(g_4[0], 5))
    { /* block id: 3 */
        uint16_t l_9 = 65535UL;
        if (g_3)
            break;
        l_9 &= (safe_rshift_func_int16_t_s_s(0xC196L, 1));
    }
    return l_10;
}
