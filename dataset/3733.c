 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 3733.c
 * Seed:      3997564962
 */
...
static volatile int32_t g_8 = 0x58FB770AL;/* VOLATILE GLOBAL g_8 */
...
static uint32_t  func_1(void)
{ /* block id: 0 */
    int16_t l_2[6] = {0L,1L,0L,0L,1L,0L};
    int i;
