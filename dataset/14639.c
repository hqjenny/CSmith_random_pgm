 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 14639.c
 * Seed:      1351931640
 */
...
static volatile int8_t g_8[1] = {0x4CL};
static int16_t g_10[2][4] = {{0xBA20L,0xBA20L,0x649FL,0xBA20L},{0xBA20L,0xD4A0L,0xD4A0L,0xBA20L}};
static volatile uint8_t g_11[6][1] = {{246UL},{246UL},{246UL},{246UL},{246UL},{246UL}};
