 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 3056.c
 * Seed:      357668502
 */
...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3[5] = {0xF2C29A3DL,0xF2C29A3DL,0xF2C29A3DL,0xF2C29A3DL,0xF2C29A3DL};
static volatile int16_t g_4 = 1L;/* VOLATILE GLOBAL g_4 */
static uint8_t g_5 = 0UL;
static volatile int16_t g_8[6] = {2L,2L,2L,2L,2L,2L};
static volatile int32_t g_9 = (-1L);/* VOLATILE GLOBAL g_9 */
static volatile uint32_t g_10 = 0xDFE0091DL;/* VOLATILE GLOBAL g_10 */
