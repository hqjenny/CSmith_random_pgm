 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 16618.c
 * Seed:      3984724526
 */
...
static int8_t  func_1(void)
{ /* block id: 0 */
    for (g_3 = 0; (g_3 < (-20)); g_3 = safe_sub_func_int16_t_s_s(g_3, 8))
    { /* block id: 3 */
        uint32_t l_9 = 0x023ED15DL;
        for (g_6 = 0; (g_6 == 13); g_6 = safe_add_func_int16_t_s_s(g_6, 5))
        { /* block id: 6 */
            l_9--;
        }
        g_6 = l_9;
        for (l_9 = 17; (l_9 != 24); ++l_9)
        { /* block id: 12 */
            const uint8_t l_14 = 0xD9L;
            g_2 = l_14;
        }
        if (g_6)
            break;
