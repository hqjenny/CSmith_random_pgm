 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 12865.c
 * Seed:      3045979752
 */
...
/* 
 * reads : g_4 g_12 g_2
 * writes: g_4 g_10 g_11 g_12 g_2 g_3
 */
static int32_t  func_1(void)
{ /* block id: 0 */
    int32_t l_9 = 0L;
    ...
    { /* block id: 3 */
        g_2 &= (g_12 |= (g_11 = (safe_rshift_func_int8_t_s_s((g_10 = l_9), 2))));
        g_3 = l_9;
        l_9 &= g_2;
    }
    return l_9;
