 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 15078.c
 * Seed:      3933396554
 */
...
static volatile int16_t g_6 = 0x8CE3L;/* VOLATILE GLOBAL g_6 */
static int16_t g_7[1][7] = {{0x551DL,0x551DL,0x551DL,0x551DL,0x551DL,0x551DL,0x551DL}};
...
{ /* block id: 0 */
    int32_t l_2[2];
    int32_t l_4 = 0L;
    int32_t l_5[6] = {0x609C3FBBL,0x609C3FBBL,0x609C3FBBL,0x609C3FBBL,0x609C3FBBL,0x609C3FBBL};
    int i;
    for (i = 0; i < 2; i++)
        l_2[i] = 1L;
