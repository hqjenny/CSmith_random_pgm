 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 3003.c
 * Seed:      72986188
 */
...
static int32_t g_6 = 0x53AA9AC7L;
...
{ /* block id: 0 */
    ...
    for (g_3 = 0; (g_3 > 9); g_3 = safe_add_func_int16_t_s_s(g_3, 6))
    { /* block id: 3 */
        for (g_6 = 0; (g_6 != 2); ++g_6)
        { /* block id: 6 */
            return l_9;
    ...
    g_2 = g_2;
    for (l_9 = 0; (l_9 < 35); l_9 = safe_add_func_uint16_t_u_u(l_9, 8))
    { /* block id: 13 */
        int32_t l_12 = 2L;
        int32_t l_13 = 8L;
        l_13 = l_12;
