 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 10346.c
 * Seed:      1295925196
 */
...
/* 
 * reads : g_6 g_3 g_14
 * writes: g_6 g_3 g_12 g_13 g_14 g_2
 */
static uint32_t  func_1(void)
{ /* block id: 0 */
    int8_t l_4 = 0L;
    int32_t l_5 = 0x9AC70C30L;
    uint8_t l_9[5];
    int i;
    for (i = 0; i < 5; i++)
        l_9[i] = 0x49L;
    ...
    { /* block id: 4 */
        int i;
        g_2 = (safe_add_func_uint16_t_u_u((g_12 = l_9[g_3]), (g_14 = (g_13 = l_9[4]))));
        return g_14;
    }
    return g_6;
}
