 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 2805.c
 * Seed:      2295437164
 */
...
{ /* block id: 0 */
    ...
    int32_t l_16 = 0x16F93BD5L;
    int i;
    for (g_3 = 0; g_3 < 5; g_3 += 1)
    {
        l_2[g_3] = 2L;
    }
    g_3 = (g_3 , (safe_lshift_func_uint8_t_u_s((safe_lshift_func_uint16_t_u_s((g_3 , (l_2[1] > ((g_3 , ((~(g_3 , (safe_unary_minus_func_int8_t_s((-3L))))) == (g_15 = (safe_rshift_func_uint8_t_u_u(((0x7213EC75L && l_2[1]) >= (safe_mod_func_uint32_t_u_u(g_14, (-7L)))), 4))))) , l_2[4]))), 0)), 1)));
    g_3 = 0x7E3B6F9BL;
    return l_16;
}
