 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 10248.c
 * Seed:      4078502496
 */
...
static int32_t g_5[7][4] = {{1L,1L,1L,1L},{1L,1L,1L,1L},{1L,1L,1L,1L},{1L,1L,1L,1L},{1L,1L,1L,1L},{1L,1L,1L,1L},{1L,1L,1L,1L}};
...
{ /* block id: 0 */
    ...
    for (g_5[1][3] = 20; (g_5[1][3] > (-29)); g_5[1][3]--)
    { /* block id: 3 */
        g_4 = l_8;
    }
    return g_3;
