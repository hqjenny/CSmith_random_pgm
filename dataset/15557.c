 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 15557.c
 * Seed:      2007371450
 */
...
static volatile uint32_t g_11 = 0x290CE96FL;/* VOLATILE GLOBAL g_11 */
...
{ /* block id: 0 */
    ...
    for (i = 0; i < 2; i++)
        l_8[i] = 0xB6EB6B9DL;
    for (g_2[2] = 13; (g_2[2] < (-30)); g_2[2] = safe_sub_func_uint16_t_u_u(g_2[2], 6))
    { /* block id: 3 */
