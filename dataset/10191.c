 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 10191.c
 * Seed:      1381814184
 */
...
static uint16_t g_5[2] = {0x1E87L,0x1E87L};
static int32_t g_6 = 0xC3EEE2FDL;
