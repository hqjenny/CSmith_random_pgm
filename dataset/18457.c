 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 18457.c
 * Seed:      3500041530
 */
...
/* ------------------------------------------ */
/* 
 * reads : g_2 g_5 g_7 g_13 g_4
 * writes: g_5 g_7 g_13
 */
static uint8_t  func_1(void)
{ /* block id: 0 */
    volatile uint32_t l_3 = 4294967290UL;/* VOLATILE GLOBAL l_3 */
    int32_t l_9 = 5L;
    l_3 = g_2[1];
    ...
    for (g_7 = 0; (g_7 == 4); g_7 = safe_add_func_uint8_t_u_u(g_7, 8))
    { /* block id: 14 */
        int32_t l_12 = 0L;
        g_13--;
    }
