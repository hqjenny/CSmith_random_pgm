 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 16881.c
 * Seed:      3862683131
 */
...
static volatile int32_t g_4 = 0x9BDBA76AL;/* VOLATILE GLOBAL g_4 */
static volatile int32_t g_5 = 0xCBA2AFE0L;/* VOLATILE GLOBAL g_5 */
static int32_t g_6[1][9] = {{0L,0L,0L,0L,0L,0L,0L,0L,0L}};
...
{ /* block id: 0 */
    int8_t l_9 = 0x73L;
    for (g_6[0][0] = 0; (g_6[0][0] < 16); g_6[0][0] = safe_add_func_uint8_t_u_u(g_6[0][0], 7))
    { /* block id: 3 */
        if (g_6[0][2])
            break;
        g_3 = g_2;
