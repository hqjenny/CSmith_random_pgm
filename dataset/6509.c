 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 6509.c
 * Seed:      3461437064
 */
...
static volatile int32_t g_5[3] = {0xC3EEE2FDL,0xC3EEE2FDL,0xC3EEE2FDL};
static int32_t g_6 = 0xD65121ACL;
...
{ /* block id: 0 */
    int8_t l_2[5];
    uint32_t l_9[8] = {0x5B054DBBL,0x5440874BL,0x5440874BL,0x5B054DBBL,0x5440874BL,0x5440874BL,0x5B054DBBL,0x5440874BL};
    int i;
    for (i = 0; i < 5; i++)
        l_2[i] = 0xFFL;
