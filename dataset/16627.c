 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 16627.c
 * Seed:      1150301006
 */
...
static int32_t g_5[1] = {0xE8E56F9BL};
...
static int16_t  func_1(void)
{ /* block id: 0 */
    int8_t l_8[2][7] = {{(-2L),(-2L),0L,(-2L),(-2L),0L,(-2L)},{0xE0L,0xD0L,0xD0L,0xE0L,0xD0L,0xD0L,0xE0L}};
    int i, j;
    for (g_5[0] = 0; (g_5[0] <= (-16)); g_5[0] = safe_sub_func_uint16_t_u_u(g_5[0], 2))
    { /* block id: 3 */
        g_2 ^= g_5[0];
    }
    return l_8[0][0];
