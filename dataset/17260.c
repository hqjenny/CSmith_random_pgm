 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 17260.c
 * Seed:      254978886
 */
...
static volatile int32_t g_5 = 0x897A4A12L;/* VOLATILE GLOBAL g_5 */
static volatile int32_t g_6 = 6L;/* VOLATILE GLOBAL g_6 */
static volatile int32_t g_7 = 0xFD4914D2L;/* VOLATILE GLOBAL g_7 */
...
{ /* block id: 0 */
    ...
    { /* block id: 3 */
        ...
        l_14 = (g_2 == (l_11 & (safe_mod_func_uint16_t_u_u(0x8819L, 0x0A50L))));
    }
    return g_6;
}
