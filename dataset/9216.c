 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 9216.c
 * Seed:      579584934
 */
...
{ /* block id: 0 */
    ...
    for (g_4 = 22; (g_4 != (-4)); g_4 = safe_sub_func_int16_t_s_s(g_4, 5))
    { /* block id: 3 */
        int32_t l_10 = 0L;
        int32_t l_12 = 2L;
        for (g_7[1] = (-1); (g_7[1] < (-24)); g_7[1]--)
        { /* block id: 6 */
            l_12 ^= (l_10 , l_11);
        }
    }
