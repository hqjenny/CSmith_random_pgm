 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 16975.c
 * Seed:      2966602945
 */
...
static int32_t g_3 = 0x8C6A53D0L;
static uint32_t g_6 = 0xCB03629AL;
...
static uint32_t  func_1(void)
{ /* block id: 0 */
    uint32_t l_9 = 0xD2250DB8L;
    for (g_3 = 0; (g_3 > (-30)); --g_3)
    { /* block id: 3 */
        g_2 = (l_9 = ((g_6 = g_2) == (g_3 | (g_3 , (safe_div_func_uint32_t_u_u(g_3, g_3))))));
        for (l_9 = (-11); (l_9 != 19); ++l_9)
        { /* block id: 9 */
            int32_t l_14 = 0xA7BC9995L;
            g_2 = (safe_rshift_func_uint8_t_u_u(g_3, 1));
            g_2 = (l_14 = l_9);
        }
    }
    return g_3;
