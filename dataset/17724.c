 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 17724.c
 * Seed:      1666665276
 */
...
static volatile int32_t g_5 = 0xB0B02971L;/* VOLATILE GLOBAL g_5 */
...
{ /* block id: 0 */
    ...
    int32_t l_11 = (-2L);
    int32_t l_12 = (-1L);
    int32_t l_13[6] = {0xCC25BFC8L,1L,0xCC25BFC8L,0xCC25BFC8L,1L,0xCC25BFC8L};
    int i;
    ...
    ++g_14;
    l_10 = (g_2 <= (safe_mod_func_int16_t_s_s(0x69ACL, (-1L))));
