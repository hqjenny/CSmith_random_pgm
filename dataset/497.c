 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 497.c
 * Seed:      734921036
 */
...
static uint32_t g_9 = 0xD44AD374L;
...
/* ------------------------------------------ */
/* 
 * reads : g_4 g_2 g_3 g_5 g_9
 * writes: g_4 g_5 g_9 g_3
 */
static int32_t  func_1(void)
{ /* block id: 0 */
    int8_t l_6 = 2L;
