 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 2307.c
 * Seed:      1424649844
 */
...
static volatile int32_t g_5[2][2] = {{(-1L),(-1L)},{(-1L),(-1L)}};
static volatile int32_t g_6 = 0x4074DD03L;/* VOLATILE GLOBAL g_6 */
