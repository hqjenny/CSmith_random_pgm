 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 6830.c
 * Seed:      3910857079
 */
...
/* --- GLOBAL VARIABLES --- */
static volatile int8_t g_6[7] = {0x5FL,0x5FL,0x5FL,0x5FL,0x5FL,0x5FL,0x5FL};
static int8_t g_7 = 0x93L;
...
{ /* block id: 0 */
    int16_t l_8 = 1L;
    g_10 = func_2(((l_8 = (g_7 = (safe_mul_func_uint16_t_u_u((0xCEL & g_6[2]), 0x3034L)))) > 0x2360L));
    return g_7;
}
