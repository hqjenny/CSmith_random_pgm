 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 1919.c
 * Seed:      654045872
 */
...
static int32_t g_4 = 0x252CB136L;
...
/* ------------------------------------------ */
/* 
 * reads : g_4 g_3 g_8 g_2
 * writes: g_4 g_3 g_8
 */
static uint32_t  func_1(void)
{ /* block id: 0 */
    uint32_t l_7[10] = {4294967295UL,0UL,4294967295UL,4294967295UL,0UL,4294967295UL,4294967295UL,0UL,4294967295UL,4294967295UL};
    int32_t l_9 = 0L;
    int i;
    for (g_4 = 0; (g_4 > (-10)); --g_4)
    { /* block id: 3 */
        g_3 |= (0x45307222L ^ l_7[6]);
        l_9 = (g_3 <= (g_8 &= g_4));
        g_8 = l_7[6];
    }
    g_3 = g_3;
