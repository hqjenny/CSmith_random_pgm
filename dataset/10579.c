 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 10579.c
 * Seed:      4061991176
 */
...
static volatile uint32_t g_3 = 0xE87DF2F4L;/* VOLATILE GLOBAL g_3 */
static volatile int16_t g_4 = 0L;/* VOLATILE GLOBAL g_4 */
static int16_t g_5[8][2] = {{0xEEE2L,5L},{0xEA68L,5L},{0xEEE2L,0xEA68L},{(-1L),(-1L)},{(-1L),0xEA68L},{0xEEE2L,5L},{0xEA68L,5L},{0xEEE2L,0xEA68L}};
