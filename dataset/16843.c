 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 16843.c
 * Seed:      4045950579
 */
...
static int32_t g_4 = 0x79763266L;
static volatile int8_t g_11[6][2] = {{0x61L,(-6L)},{(-6L),0x61L},{(-6L),(-6L)},{0x61L,(-6L)},{(-6L),0x61L},{(-6L),(-6L)}};
...
static int8_t  func_1(void)
{ /* block id: 0 */
    int32_t l_7 = 0x6A485BF2L;
    int32_t l_8 = 0x61AB6EC7L;
    int32_t l_9 = 0L;
