 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 7657.c
 * Seed:      1226576128
 */
...
static volatile int32_t g_3[6][2][1] = {{{(-4L)},{7L}},{{(-4L)},{7L}},{{(-4L)},{7L}},{{(-4L)},{7L}},{{(-4L)},{7L}},{{(-4L)},{7L}}};
...
static int16_t  func_1(void)
{ /* block id: 0 */
    for (g_4 = (-15); (g_4 == 6); g_4 = safe_add_func_uint16_t_u_u(g_4, 7))
    { /* block id: 3 */
        return g_3[1][0][0];
    }
    return g_3[1][0][0];
