 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 15280.c
 * Seed:      1437804434
 */
...
static int16_t g_6[4] = {0L,0L,0L,0L};
...
static uint8_t  func_1(void)
{ /* block id: 0 */
    const uint8_t l_9[2][8] = {{0x02L,0x02L,0UL,0x02L,0x02L,0UL,0x02L,0x02L},{0xE7L,0x02L,0xE7L,0xE7L,0x02L,0xE7L,0xE7L,0x02L}};
    int i, j;
