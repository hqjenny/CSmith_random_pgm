 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 5545.c
 * Seed:      2830605843
 */
...
static int32_t g_7 = 0xA485BF25L;
...
/* ------------------------------------------ */
/* 
 * reads : g_4 g_7 g_2 g_3
 * writes: g_4 g_7
 */
static uint32_t  func_1(void)
{ /* block id: 0 */
    uint8_t l_15 = 0x61L;
    for (g_4 = 12; (g_4 <= (-14)); g_4--)
    { /* block id: 3 */
        uint8_t l_13 = 0x14L;
        for (g_7 = 1; (g_7 != (-9)); g_7--)
        { /* block id: 6 */
            uint32_t l_10 = 0xA0734F09L;
            int32_t l_14 = (-3L);
            ++l_10;
            l_14 = (l_13 = (0x6887E08AL ^ g_2));
            if (g_3)
                continue;
        }
    }
