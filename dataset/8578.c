 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 8578.c
 * Seed:      3743613284
 */
...
static volatile int32_t g_3 = 0xE48D327CL;/* VOLATILE GLOBAL g_3 */
static volatile int32_t g_4 = 5L;/* VOLATILE GLOBAL g_4 */
static volatile int32_t g_5 = 1L;/* VOLATILE GLOBAL g_5 */
static volatile int32_t g_6[8][3] = {{0x683C8FC5L,5L,(-8L)},{5L,(-7L),(-7L)},{(-2L),0x683C8FC5L,(-8L)},{2L,0xC04EE7D2L,0x683C8FC5L},{2L,0L,5L},{(-2L),4L,(-2L)},{5L,0L,2L},{0x683C8FC5L,0xC04EE7D2L,2L}};
