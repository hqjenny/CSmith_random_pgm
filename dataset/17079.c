 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 17079.c
 * Seed:      4064186681
 */
...
static uint16_t g_13[8] = {0xF4C5L,0xDF3DL,0xF4C5L,0xF4C5L,0xDF3DL,0xF4C5L,0xF4C5L,0xDF3DL};
...
static const int32_t  func_1(void)
{ /* block id: 0 */
    int8_t l_5[5] = {0xE4L,0xE4L,0xE4L,0xE4L,0xE4L};
    int i;
    l_5[0] = (safe_mul_func_int16_t_s_s(4L, g_4));
    for (g_7 = 26; (g_7 != 18); g_7 = safe_sub_func_int16_t_s_s(g_7, 9))
    { /* block id: 4 */
        const uint8_t l_12 = 0x0FL;
        g_6 = (safe_add_func_uint8_t_u_u(l_12, (g_13[1] &= l_12)));
    }
    return g_13[1];
}
