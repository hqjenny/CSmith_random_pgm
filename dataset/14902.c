 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 14902.c
 * Seed:      906713754
 */
...
static int32_t g_6 = 0x457102D1L;
...
static const int32_t  func_1(void)
{ /* block id: 0 */
    for (g_6 = 15; (g_6 == (-27)); g_6 = safe_sub_func_uint16_t_u_u(g_6, 7))
    { /* block id: 3 */
        const uint16_t l_9 = 0x33C6L;
        return l_9;
    }
    return g_2;
}
