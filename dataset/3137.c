 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 3137.c
 * Seed:      2026959314
 */
...
static int32_t g_10 = 0xAB60E704L;
...
{ /* block id: 0 */
    ...
    l_2--;
    for (l_2 = (-4); (l_2 == 7); l_2 = safe_add_func_uint8_t_u_u(l_2, 6))
    { /* block id: 4 */
        uint32_t l_7[6];
        int32_t l_8[1][8] = {{3L,0x82FF40FCL,3L,3L,0x82FF40FCL,3L,3L,0x82FF40FCL}};
        int i, j;
        for (i = 0; i < 6; i++)
            l_7[i] = 0x304B25B3L;
        l_8[0][5] = l_7[4];
