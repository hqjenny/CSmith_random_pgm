 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 7509.c
 * Seed:      328332692
 */
...
static int32_t g_4[1] = {0xAF43B7C7L};
...
{ /* block id: 0 */
    int8_t l_7 = 0x24L;
    int32_t l_8 = 0x891C5534L;
    int32_t l_9 = 0x7FBF2121L;
    int32_t l_10 = 0L;
    int32_t l_11[9];
    int8_t l_12 = 0x49L;
    uint32_t l_13 = 8UL;
    ...
    for (i = 0; i < 9; i++)
        l_11[i] = 1L;
    for (g_4[0] = 0; (g_4[0] > 19); g_4[0] = safe_add_func_int16_t_s_s(g_4[0], 8))
    { /* block id: 3 */
        return l_7;
    }
    ++l_13;
