 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 5908.c
 * Seed:      1168977198
 */
...
static volatile int32_t g_5 = 0x5CDBE8E5L;/* VOLATILE GLOBAL g_5 */
static int32_t g_6[10][2] = {{(-8L),0x0B999FB0L},{0L,0L},{0x0B999FB0L,(-8L)},{(-4L),(-8L)},{0x0B999FB0L,0L},{0L,0x0B999FB0L},{(-8L),(-4L)},{(-8L),0x0B999FB0L},{0L,0L},{0x0B999FB0L,(-8L)}};
...
static uint32_t  func_1(void)
{ /* block id: 0 */
    for (g_6[6][1] = 0; (g_6[6][1] > (-16)); --g_6[6][1])
    { /* block id: 3 */
        g_2 |= g_6[4][0];
    }
    return g_3;
