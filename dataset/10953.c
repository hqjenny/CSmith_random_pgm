 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 10953.c
 * Seed:      1409453380
 */
...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3 = 0x3F4F46DBL;
...
lbl_6:
    ...
    { /* block id: 8 */
        ...
        if (g_3)
        { /* block id: 10 */
            uint32_t l_9 = 0x37A9A971L;
            l_9 = (safe_lshift_func_uint8_t_u_u(g_3, 2));
        }
        else
        { /* block id: 12 */
            g_10 = g_3;
