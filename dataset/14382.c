 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 14382.c
 * Seed:      3503076588
 */
...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_2[2] = {8L,8L};
...
{ /* block id: 0 */
    ...
    int32_t l_9 = (-5L);
    uint32_t l_13 = 2UL;
    for (g_5 = 0; (g_5 >= 22); g_5 = safe_add_func_int32_t_s_s(g_5, 6))
    { /* block id: 3 */
        uint32_t l_10 = 2UL;
        ++l_10;
    }
