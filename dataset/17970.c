 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 17970.c
 * Seed:      1748808282
 */
...
static volatile int32_t g_3[3] = {5L,5L,5L};
static int32_t g_4 = 0xAA32B1CEL;
...
/* ------------------------------------------ */
/* 
 * reads : g_4 g_9 g_3 g_8 g_2
 * writes: g_4 g_9 g_8
 */
static uint16_t  func_1(void)
{ /* block id: 0 */
    for (g_4 = 0; (g_4 < (-3)); g_4 = safe_sub_func_int16_t_s_s(g_4, 3))
    { /* block id: 3 */
