 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 17044.c
 * Seed:      3397713207
 */
...
static volatile int32_t g_8 = 0xCEAFD94FL;/* VOLATILE GLOBAL g_8 */
...
{ /* block id: 0 */
    int32_t l_13 = (-1L);
    for (g_5 = 0; (g_5 > 27); g_5 = safe_add_func_int16_t_s_s(g_5, 2))
    { /* block id: 3 */
        uint16_t l_14 = 2UL;
