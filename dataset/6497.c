 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 6497.c
 * Seed:      3908224814
 */
...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_3[4] = {(-10L),(-10L),(-10L),(-10L)};
...
static int32_t g_10 = 0xF37C04CCL;
