 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 12812.c
 * Seed:      113046456
 */
...
static volatile int16_t g_5 = 8L;/* VOLATILE GLOBAL g_5 */
static volatile uint16_t g_6[10][1] = {{0x0897L},{0xA756L},{0x0897L},{0xA756L},{0x0897L},{0xA756L},{0x0897L},{0xA756L},{0x0897L},{0xA756L}};
