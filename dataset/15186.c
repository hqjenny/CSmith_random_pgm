 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 15186.c
 * Seed:      53294102
 */
...
static uint32_t  func_1(void)
{ /* block id: 0 */
    int8_t l_8[2][4] = {{0x72L,0x72L,0x72L,0x72L},{0x72L,0x72L,0x72L,0x72L}};
    int i, j;
    ...
    { /* block id: 3 */
        ...
        { /* block id: 6 */
            if (l_8[1][2])
                break;
            g_11 = (safe_lshift_func_uint8_t_u_u((0x5FCC58A0L > 1UL), g_2));
        }
        return g_11;
    }
    return g_12;
