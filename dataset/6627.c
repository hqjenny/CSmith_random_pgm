 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 6627.c
 * Seed:      3342571418
 */
...
{ /* block id: 0 */
    ...
    int32_t l_7[6] = {0L,0xA34C865BL,0L,0L,0xA34C865BL,0L};
    int i;
    ...
    { /* block id: 8 */
        int32_t l_5[9] = {0xD952EAA2L,0xD952EAA2L,0xD952EAA2L,0xD952EAA2L,0xD952EAA2L,0xD952EAA2L,0xD952EAA2L,0xD952EAA2L,0xD952EAA2L};
        int i;
        l_5[6] = (-1L);
        if (l_2[g_4])
            continue;
