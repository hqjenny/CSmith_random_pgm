 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 7707.c
 * Seed:      1594948569
 */
...
static volatile int32_t g_6[1][2] = {{0xD925B0E4L,0xD925B0E4L}};
static int32_t g_7 = 0xDB34E6D4L;
...
static const uint16_t  func_1(void)
{ /* block id: 0 */
    for (g_7 = 0; (g_7 > 24); g_7 = safe_add_func_int8_t_s_s(g_7, 3))
    { /* block id: 3 */
        uint32_t l_10[6] = {0xE30F5872L,0xE30F5872L,0xE30F5872L,0xE30F5872L,0xE30F5872L,0xE30F5872L};
        int i;
        if (g_2)
            break;
        l_10[1]--;
