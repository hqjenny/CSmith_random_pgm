 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 12718.c
 * Seed:      2971618098
 */
...
static uint16_t  func_1(void)
{ /* block id: 0 */
    int8_t l_8[6] = {1L,0xF8L,1L,1L,0xF8L,1L};
    int32_t l_10 = 2L;
    int i;
    for (g_2 = 4; (g_2 < 19); ++g_2)
    { /* block id: 3 */
        g_7 = (safe_sub_func_uint32_t_u_u(g_2, (-10L)));
    }
