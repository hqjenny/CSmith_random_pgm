 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 7822.c
 * Seed:      1678058149
 */
...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_2 = 0xFFB871C7L;/* VOLATILE GLOBAL g_2 */
static uint16_t g_3 = 0xCB51L;
static uint16_t g_7 = 0x53E5L;
static volatile int16_t g_8[2][5] = {{1L,1L,1L,1L,1L},{0L,0L,0L,0L,0L}};
