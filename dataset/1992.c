 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 1992.c
 * Seed:      3905117444
 */
...
static volatile uint8_t g_5[9] = {0x73L,0x73L,0x73L,0x73L,0x73L,0x73L,0x73L,0x73L,0x73L};
static uint32_t g_9[3][2] = {{0x31EB2391L,0UL},{0UL,0x31EB2391L},{0UL,0UL}};
