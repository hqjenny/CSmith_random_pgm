 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 18084.c
 * Seed:      309473097
 */
...
static int32_t g_3[9][1] = {{0xC0AE9714L},{7L},{0xC0AE9714L},{7L},{0xC0AE9714L},{7L},{0xC0AE9714L},{7L},{0xC0AE9714L}};
static int32_t g_7 = 0x00F47A6DL;
static int32_t g_8 = 0L;
static int32_t g_9 = 0x41FC9A57L;
...
/* ------------------------------------------ */
/* 
 * reads : g_3 g_7 g_8 g_9 g_2
 * writes: g_3 g_7 g_8 g_9 g_2
 */
static int8_t  func_1(void)
{ /* block id: 0 */
    for (g_3[1][0] = 0; (g_3[1][0] < (-11)); g_3[1][0]--)
    { /* block id: 3 */
        int16_t l_6[2];
        int i;
        for (i = 0; i < 2; i++)
