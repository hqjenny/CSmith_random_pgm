 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 17272.c
 * Seed:      3724668981
 */
...
static int32_t g_7[2][3][1] = {{{0x4C23AFC3L},{0x25A80E35L},{0x4C23AFC3L}},{{0x25A80E35L},{0x4C23AFC3L},{0x25A80E35L}}};
