 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 2725.c
 * Seed:      3980080176
 */
...
static int16_t g_4[3] = {0x82EAL,0x82EAL,0x82EAL};
...
static volatile int32_t g_8 = 0xD8F8F576L;/* VOLATILE GLOBAL g_8 */
static volatile int32_t g_9[2][1][4] = {{{0L,1L,0L,1L}},{{0L,1L,0L,1L}}};
...
/* ------------------------------------------ */
/* 
 * reads : g_3 g_4 g_7 g_11 g_5 g_12
 * writes: g_3 g_4 g_7 g_11 g_5 g_12 g_10
 */
static int8_t  func_1(void)
{ /* block id: 0 */
    uint32_t l_2[2][4];
