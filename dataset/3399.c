 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 3399.c
 * Seed:      2049945622
 */
...
static volatile int32_t g_10 = 0x72159124L;/* VOLATILE GLOBAL g_10 */
static int32_t g_11[3] = {0x29EA4144L,0x29EA4144L,0x29EA4144L};
...
{ /* block id: 0 */
    ...
    { /* block id: 3 */
        ...
        { /* block id: 6 */
            for (g_11[0] = (-23); (g_11[0] >= (-19)); g_11[0] = safe_add_func_int32_t_s_s(g_11[0], 6))
            { /* block id: 9 */
                if (g_11[2])
                    break;
            }
