 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 10913.c
 * Seed:      3623778468
 */
...
static int32_t g_5[3][3][2] = {{{(-1L),(-1L)},{(-1L),(-1L)},{(-1L),(-1L)}},{{(-1L),(-1L)},{(-1L),(-1L)},{(-1L),(-1L)}},{{(-1L),(-1L)},{(-1L),(-1L)},{(-1L),(-1L)}}};
...
{ /* block id: 0 */
    uint8_t l_8 = 0x6EL;
    for (g_5[0][2][1] = 9; (g_5[0][2][1] > 28); g_5[0][2][1]++)
    { /* block id: 3 */
        g_2 = g_5[2][1][1];
    }
    return l_8;
