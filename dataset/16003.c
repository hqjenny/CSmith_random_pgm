 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 16003.c
 * Seed:      3769736608
 */
...
static int8_t g_7 = 0xE9L;
static int32_t g_10[3][6][1] = {{{0x04445559L},{0L},{0x04445559L},{0L},{0x04445559L},{0L}},{{0x04445559L},{0L},{0x04445559L},{0L},{0x04445559L},{0L}},{{0x04445559L},{0L},{0x04445559L},{0L},{0x04445559L},{0L}}};
