 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 15230.c
 * Seed:      310556324
 */
...
static int32_t g_11 = 0x6E7F737AL;
...
{ /* block id: 0 */
    int16_t l_2[2];
    int32_t l_12 = 4L;
    int32_t l_16[3][6] = {{0L,0xB4E76AB2L,1L,1L,0xB4E76AB2L,0L},{4L,0L,(-8L),0xB4E76AB2L,(-8L),0L},{(-8L),4L,1L,0xFA831EB2L,0xFA831EB2L,1L}};
    int32_t l_19 = 0xD2B5F791L;
    int i, j;
    for (i = 0; i < 2; i++)
        l_2[i] = 0xD5E4L;
    ...
    l_12 = (safe_lshift_func_uint8_t_u_u((0L | 1UL), g_11));
    return l_19;
}
