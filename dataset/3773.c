 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 3773.c
 * Seed:      341972652
 */
...
static int32_t g_3[2][7] = {{0x176B0F73L,3L,(-8L),(-8L),3L,0x176B0F73L,3L},{1L,0x176B0F73L,0x176B0F73L,1L,3L,1L,0x176B0F73L}};
...
{ /* block id: 0 */
    int16_t l_7 = 0x310FL;
    for (g_3[1][1] = 19; (g_3[1][1] <= 14); --g_3[1][1])
    { /* block id: 3 */
        if (g_3[1][2])
            break;
    }
    g_3[1][1] = g_3[1][0];
    g_3[1][0] ^= (~((l_7 >= g_2) == (safe_rshift_func_uint16_t_u_s(65535UL, 6))));
    return g_3[1][1];
}
