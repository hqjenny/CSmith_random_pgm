 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 13617.c
 * Seed:      714425887
 */
...
/* --- GLOBAL VARIABLES --- */
static uint16_t g_2[2] = {0x3DF7L,0x3DF7L};
static volatile int32_t g_3[1] = {0x490C4D8EL};
...
{ /* block id: 0 */
    int32_t l_10 = 0L;
    int32_t l_12 = 8L;
    uint32_t l_13 = 0xF889A278L;
    for (g_6 = 0; (g_6 <= 1); g_6 += 1)
    { /* block id: 3 */
        int32_t l_7 = 0x78144AD7L;
        int32_t l_8 = 0xD1AD67A4L;
        int32_t l_11[2];
        int i;
        for (i = 0; i < 2; i++)
            l_11[i] = 0x08F4727CL;
