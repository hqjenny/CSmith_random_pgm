 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 3477.c
 * Seed:      1131395286
 */
...
static int32_t g_8 = 0x25FCC58AL;
static volatile uint8_t g_9 = 255UL;/* VOLATILE GLOBAL g_9 */
static volatile uint16_t g_12 = 0x6C31L;/* VOLATILE GLOBAL g_12 */
...
static uint16_t  func_1(void)
{ /* block id: 0 */
    int8_t l_2[7] = {1L,0x24L,1L,1L,0x24L,1L,1L};
    int32_t l_6 = (-1L);
    int i;
    for (g_4 = 6; (g_4 >= 0); g_4 -= 1)
    { /* block id: 3 */
        int16_t l_5 = 0x2159L;
        int32_t l_7 = 0xB37B0480L;
        ++g_9;
        g_12++;
    }
    return l_2[1];
