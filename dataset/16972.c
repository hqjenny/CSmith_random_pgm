 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 16972.c
 * Seed:      3568439081
 */
...
/* --- GLOBAL VARIABLES --- */
static int8_t g_2[1][7][1] = {{{0x4AL},{(-4L)},{(-4L)},{0x4AL},{(-4L)},{(-4L)},{0x4AL}}};
static int32_t g_3 = (-1L);
static volatile int32_t g_4 = 0x136951ADL;/* VOLATILE GLOBAL g_4 */
