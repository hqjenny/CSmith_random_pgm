 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 15935.c
 * Seed:      3088942452
 */
...
{ /* block id: 0 */
    ...
    for (g_5 = (-18); (g_5 != 22); g_5 = safe_add_func_uint8_t_u_u(g_5, 9))
    { /* block id: 4 */
        g_4 = l_8;
        g_4 = l_8;
        if (g_4)
