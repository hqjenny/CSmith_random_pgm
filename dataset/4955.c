 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 4955.c
 * Seed:      2968254545
 */
...
static int32_t g_8 = 0xA290BE44L;
...
static uint32_t  func_1(void)
{ /* block id: 0 */
    int16_t l_2[4] = {0x204EL,0x204EL,0x204EL,0x204EL};
    int32_t l_9 = 0x0DE9BF9FL;
