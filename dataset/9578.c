 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 9578.c
 * Seed:      1373553584
 */
...
static volatile int32_t g_5[5][3] = {{0L,0L,1L},{(-10L),0L,(-10L)},{1L,0L,1L},{1L,1L,0L},{(-10L),0L,0L}};
static int32_t g_6 = 0x2EAC4530L;
...
static uint32_t  func_1(void)
{ /* block id: 0 */
    for (g_6 = 0; (g_6 == (-8)); g_6 = safe_sub_func_int16_t_s_s(g_6, 1))
    { /* block id: 3 */
        return g_4;
    }
    return g_4;
