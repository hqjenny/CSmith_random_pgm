 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 16545.c
 * Seed:      1060198527
 */
...
static int32_t g_4[10] = {2L,0x8E5CCC90L,(-1L),(-1L),0x8E5CCC90L,2L,0x8E5CCC90L,(-1L),(-1L),0x8E5CCC90L};
...
{ /* block id: 0 */
    uint8_t l_8 = 0x76L;
    for (g_4[1] = 3; (g_4[1] == (-2)); g_4[1] = safe_sub_func_uint16_t_u_u(g_4[1], 8))
    { /* block id: 3 */
        const uint32_t l_7 = 0x1C157478L;
        if (l_7)
            break;
        if (l_8)
            break;
