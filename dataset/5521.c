 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 5521.c
 * Seed:      2651107360
 */
...
static int16_t  func_1(void)
{ /* block id: 0 */
    uint8_t l_2[5][2] = {{0xBCL,0xBCL},{0xBCL,0xBCL},{0xBCL,0xBCL},{0xBCL,0xBCL},{0xBCL,0xBCL}};
    int32_t l_6[10] = {(-1L),(-1L),(-1L),(-1L),(-1L),(-1L),(-1L),(-1L),(-1L),(-1L)};
    int i, j;
