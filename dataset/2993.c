 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 2993.c
 * Seed:      3349067484
 */
...
static uint32_t g_8 = 0x53D42374L;
...
{ /* block id: 0 */
    ...
    l_2 = (-5L);
    g_4 &= (g_3[0] != g_3[0]);
    for (g_4 = 0; (g_4 > 14); g_4 = safe_add_func_uint16_t_u_u(g_4, 2))
    { /* block id: 5 */
        int16_t l_7 = 0xEA2AL;
        if (l_7)
            break;
