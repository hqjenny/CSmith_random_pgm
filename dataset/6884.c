 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 6884.c
 * Seed:      1772160910
 */
...
/* --- GLOBAL VARIABLES --- */
static int8_t g_4[3][2][1] = {{{0x0DL},{0x7FL}},{{0x0DL},{0x7FL}},{{0x0DL},{0x7FL}}};
...
{ /* block id: 0 */
    uint16_t l_2[6];
    int32_t l_3 = 0x3ED15DE0L;
    int32_t l_5 = 0x8E1B8814L;
    int32_t l_8 = 0xFCE2949FL;
    int i;
    for (i = 0; i < 6; i++)
        l_2[i] = 0x18D5L;
    l_8 ^= ((g_6 |= (l_5 = (g_4[2][1][0] = (l_3 = (l_2[0] < l_2[0]))))) >= ((g_7 >= g_7) ^ l_2[2]));
    return l_2[3];
}
