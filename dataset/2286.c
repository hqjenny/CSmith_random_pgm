 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 2286.c
 * Seed:      3566788554
 */
...
static int32_t g_4 = 0x1A3622BAL;
static volatile uint8_t g_10[3] = {1UL,1UL,1UL};
...
/* ------------------------------------------ */
/* 
 * reads : g_4 g_2 g_3 g_10
 * writes: g_4 g_3 g_2 g_10
 */
static uint32_t  func_1(void)
{ /* block id: 0 */
    uint8_t l_7 = 0x49L;
    int32_t l_8 = (-6L);
    int32_t l_9 = 0xADF1ADB2L;
