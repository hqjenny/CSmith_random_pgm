 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 12507.c
 * Seed:      3690640956
 */
...
static uint32_t g_3[1][10] = {{0UL,0UL,0UL,0UL,0UL,0UL,0UL,0UL,0UL,0UL}};
...
static int16_t  func_1(void)
{ /* block id: 0 */
    int32_t l_4 = 0x0CD50997L;
    int32_t l_6 = (-1L);
    int32_t l_7 = 0x42374B1BL;
    int32_t l_13 = 0x207647F1L;
    g_3[0][5] = g_2;
    ++g_8;
    for (g_8 = (-23); (g_8 == 50); ++g_8)
    { /* block id: 5 */
        if (g_5)
        { /* block id: 6 */
            l_7 = (g_2 | g_2);
