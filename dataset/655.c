 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 655.c
 * Seed:      2888464368
 */
...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_3 = 0xC69AED23L;/* VOLATILE GLOBAL g_3 */
...
static uint16_t  func_1(void)
{ /* block id: 0 */
    int32_t l_2[6] = {0xB13638ECL,0x42EB90DAL,0xB13638ECL,0xB13638ECL,0x42EB90DAL,0xB13638ECL};
    int i;
