 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 4813.c
 * Seed:      518831675
 */
...
static volatile uint32_t g_15 = 0x076FDA02L;/* VOLATILE GLOBAL g_15 */
...
/* ------------------------------------------ */
/* 
 * reads : g_3 g_2 g_11 g_15
 * writes: g_3 g_2 g_11 g_15
 */
static uint8_t  func_1(void)
{ /* block id: 0 */
    uint8_t l_9 = 255UL;
