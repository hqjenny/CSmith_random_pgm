 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 9021.c
 * Seed:      3625081858
 */
...
static volatile uint32_t g_9[2] = {0xEE6D058AL,0xEE6D058AL};
...
static uint16_t  func_1(void)
{ /* block id: 0 */
    const int32_t l_3 = 0x76F5020FL;
    int32_t l_8 = 0xAFA2FAFDL;
    g_4 = (+l_3);
    for (g_4 = (-9); (g_4 == 21); g_4++)
    { /* block id: 4 */
        int16_t l_12 = 1L;
        --g_9[0];
        if (l_12)
