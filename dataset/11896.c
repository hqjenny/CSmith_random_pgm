 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 11896.c
 * Seed:      843938016
 */
...
static int16_t g_6[10] = {(-5L),0x9E2AL,0xE64FL,0xE64FL,0x9E2AL,(-5L),0x9E2AL,0xE64FL,0xE64FL,0x9E2AL};
...
{ /* block id: 0 */
    ...
    g_3 = ((g_3 , 5L) != (func_4(((g_6[4] &= l_2[1]) || l_2[0])) < g_3));
    return l_2[2];
}
