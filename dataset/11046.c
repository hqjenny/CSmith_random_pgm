 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 11046.c
 * Seed:      1289496542
 */
...
static int32_t g_10 = 0x45625132L;
...
static int32_t  func_1(void)
{ /* block id: 0 */
    int16_t l_7[5] = {0x1173L,0x1173L,0x1173L,0x1173L,0x1173L};
    int i;
