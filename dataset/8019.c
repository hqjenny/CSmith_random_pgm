 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 8019.c
 * Seed:      16423566
 */
...
static volatile int32_t g_9 = 0xED15DE05L;/* VOLATILE GLOBAL g_9 */
static volatile int32_t g_10 = 0L;/* VOLATILE GLOBAL g_10 */
static int32_t g_11 = 0x00585B7FL;
...
static uint8_t  func_1(void)
{ /* block id: 0 */
    int32_t l_18 = 0x2215256EL;
    for (g_3 = 0; (g_3 == 21); g_3 = safe_add_func_int32_t_s_s(g_3, 6))
    { /* block id: 3 */
        uint32_t l_6[1][4] = {{5UL,5UL,5UL,5UL}};
        int i, j;
        ...
        { /* block id: 6 */
            ...
            { /* block id: 10 */
                int16_t l_17 = 0xF23EL;
                int i, j;
                g_7 = (l_6[l_12][(l_12 + 2)] , ((safe_rshift_func_int8_t_s_s(l_17, 3)) == 0xB5486B6FL));
            }
        }
    }
    return l_18;
