 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 1842.c
 * Seed:      4107076342
 */
...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_2[1][9] = {{(-7L),(-7L),(-7L),(-7L),(-7L),(-7L),(-7L),(-7L),(-7L)}};
...
/* 
 * reads : g_4 g_2
 * writes: g_4 g_11 g_12 g_2
 */
static uint32_t  func_1(void)
{ /* block id: 0 */
    uint16_t l_10 = 0x2FBBL;
    for (g_4 = (-20); (g_4 >= 8); g_4++)
    { /* block id: 3 */
        int8_t l_9 = 0L;
        int32_t l_13 = 0x4F98CAFAL;
        l_13 = (g_2[0][8] || ((g_12 = (g_11 = ((l_10 |= (safe_mul_func_uint8_t_u_u(l_9, g_2[0][4]))) || l_9))) > l_9));
        g_2[0][4] = (-1L);
    }
    return l_10;
}
