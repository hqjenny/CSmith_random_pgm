 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 5889.c
 * Seed:      916693342
 */
...
static int32_t g_4 = 0x4504CD45L;
...
static uint8_t  func_1(void)
{ /* block id: 0 */
    uint32_t l_7 = 0x83111738L;
    int32_t l_10 = 0xE8588D0DL;
    int32_t l_14 = 0x7563FFAFL;
    int32_t l_15 = (-8L);
    for (g_4 = 12; (g_4 == 22); g_4++)
    { /* block id: 3 */
        int32_t l_11[9];
        int16_t l_12 = 0xD513L;
        int i;
        for (i = 0; i < 9; i++)
            l_11[i] = 0x43EB6069L;
        l_7++;
        g_16++;
        for (l_12 = (-15); (l_12 <= (-11)); ++l_12)
        { /* block id: 8 */
            if (l_11[2])
                break;
        }
