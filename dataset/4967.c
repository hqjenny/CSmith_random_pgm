 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 4967.c
 * Seed:      1409237087
 */
...
static int16_t  func_1(void)
{ /* block id: 0 */
    uint32_t l_6 = 0xA4F402E3L;
    int32_t l_13 = 0x727CAD7DL;
    int32_t l_14 = 0xFF44CACFL;
    uint32_t l_15 = 0UL;
    g_18 = (func_2((safe_mul_func_uint8_t_u_u(0x0AL, l_6))) ^ (2UL >= (safe_unary_minus_func_int32_t_s((safe_sub_func_uint32_t_u_u((++l_15), g_8))))));
    return l_6;
}
