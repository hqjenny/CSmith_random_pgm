 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 9893.c
 * Seed:      760984162
 */
...
static volatile int32_t g_4 = 0x9B546158L;/* VOLATILE GLOBAL g_4 */
static int32_t g_5[2][1] = {{9L},{9L}};
static uint32_t g_8 = 0xF8C7B5C6L;
...
lbl_11:
    for (g_5[1][0] = 2; (g_5[1][0] >= 0); g_5[1][0] -= 1)
    { /* block id: 3 */
        int32_t l_6 = (-1L);
        g_8++;
        g_4 = l_6;
