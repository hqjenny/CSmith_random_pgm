 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 16870.c
 * Seed:      1360858890
 */
...
static uint32_t  func_1(void)
{ /* block id: 0 */
    uint32_t l_9 = 0xE3E63E31L;
    int32_t l_15 = 0xADB2BC40L;
    for (g_2 = 0; (g_2 <= (-16)); g_2 = safe_sub_func_int16_t_s_s(g_2, 7))
    { /* block id: 3 */
        for (g_5[1] = 0; (g_5[1] <= (-22)); --g_5[1])
        { /* block id: 6 */
            int16_t l_8 = 5L;
            l_9 = l_8;
