 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 16873.c
 * Seed:      2429586072
 */
...
static int16_t g_12[1] = {0x5A97L};
static int16_t g_13 = 0xE649L;
