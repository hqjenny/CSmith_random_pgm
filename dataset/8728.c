 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 8728.c
 * Seed:      3071666186
 */
...
static volatile int32_t g_9 = 0xADF1ADB2L;/* VOLATILE GLOBAL g_9 */
...
static int32_t  func_1(void)
{ /* block id: 0 */
    uint16_t l_7[6][3] = {{0xC79EL,65535UL,65535UL},{0xCE3EL,65535UL,0UL},{65531UL,0xC79EL,0x551DL},{0xCE3EL,0xCE3EL,0x551DL},{0xC79EL,65531UL,0UL},{65535UL,0xCE3EL,65535UL}};
    int i, j;
