 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 5644.c
 * Seed:      3050562052
 */
...
static int32_t g_3 = 0xE48D327CL;
...
{ /* block id: 0 */
    uint8_t l_8 = 0x21L;
    int32_t l_9 = (-1L);
    int8_t l_10[10] = {(-5L),(-5L),(-5L),(-5L),(-5L),(-5L),(-5L),(-5L),(-5L),(-5L)};
    int i;
