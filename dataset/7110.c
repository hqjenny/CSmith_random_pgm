 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 7110.c
 * Seed:      3233748900
 */
...
static volatile int32_t g_4 = 0xDB505206L;/* VOLATILE GLOBAL g_4 */
...
{ /* block id: 0 */
    ...
    { /* block id: 3 */
        uint32_t l_10[3][1][4] = {{{0xB8F5F499L,0xB8F5F499L,0xB8F5F499L,0xB8F5F499L}},{{0xB8F5F499L,0xB8F5F499L,0xB8F5F499L,0xB8F5F499L}},{{0xB8F5F499L,0xB8F5F499L,0xB8F5F499L,0xB8F5F499L}}};
        int i, j, k;
        l_10[0][0][1]--;
        if (g_4)
            break;
