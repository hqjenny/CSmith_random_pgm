 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 18357.c
 * Seed:      3511898403
 */
...
static int32_t g_6[9] = {0x3245F1DBL,0x3245F1DBL,0x3245F1DBL,0x3245F1DBL,0x3245F1DBL,0x3245F1DBL,0x3245F1DBL,0x3245F1DBL,0x3245F1DBL};
...
static const int16_t  func_1(void)
{ /* block id: 0 */
    for (g_6[5] = 3; (g_6[5] < 0); g_6[5] = safe_sub_func_int8_t_s_s(g_6[5], 6))
    { /* block id: 3 */
        return g_5;
    }
    return g_6[5];
