 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 18548.c
 * Seed:      2061904507
 */
...
static volatile int16_t g_3[1][7] = {{6L,(-4L),6L,6L,(-4L),6L,6L}};
static volatile int32_t g_4 = 8L;/* VOLATILE GLOBAL g_4 */
static volatile int8_t g_6 = (-1L);/* VOLATILE GLOBAL g_6 */
static volatile uint8_t g_7[4][2][1] = {{{0x4BL},{0xA2L}},{{0x4BL},{0xA2L}},{{0x4BL},{0xA2L}},{{0x4BL},{0xA2L}}};
