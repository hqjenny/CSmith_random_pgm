 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 10925.c
 * Seed:      1579708270
 */
...
static int32_t  func_1(void)
{ /* block id: 0 */
    uint16_t l_7 = 0xCCB6L;
    for (g_3 = 12; (g_3 <= (-26)); --g_3)
    { /* block id: 3 */
        uint16_t l_6[3][6] = {{0xE05DL,0UL,0UL,0xE05DL,0xE05DL,0UL},{0xE05DL,0xE05DL,0UL,0UL,0xE05DL,0xE05DL},{0xE05DL,0UL,0UL,0xE05DL,0xE05DL,0UL}};
        int i, j;
        if (g_3)
        { /* block id: 4 */
            uint8_t l_8 = 255UL;
