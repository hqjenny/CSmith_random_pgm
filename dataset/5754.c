 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 5754.c
 * Seed:      3661322477
 */
...
static int32_t g_4 = 0x33FCB50BL;
static volatile uint16_t g_5 = 3UL;/* VOLATILE GLOBAL g_5 */
...
/* ------------------------------------------ */
/* 
 * reads : g_4 g_5 g_8 g_3
 * writes: g_4 g_5 g_8 g_3
 */
static int16_t  func_1(void)
{ /* block id: 0 */
    int32_t l_2[7];
    ...
    { /* block id: 3 */
        ...
        { /* block id: 7 */
            int i;
            g_3 |= (safe_add_func_uint16_t_u_u(l_2[g_4], 0x3083L));
        }
    }
    g_4 = (safe_sub_func_uint16_t_u_u(l_2[5], l_2[1]));
    l_2[4] = g_5;
    return l_2[3];
}
