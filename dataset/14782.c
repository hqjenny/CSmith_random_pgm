 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 14782.c
 * Seed:      1520016023
 */
...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3[7] = {0x5C8094A1L,0x5C8094A1L,0x5C8094A1L,0x5C8094A1L,0x5C8094A1L,0x5C8094A1L,0x5C8094A1L};
...
static const int8_t  func_1(void)
{ /* block id: 0 */
    int16_t l_2[4] = {6L,6L,6L,6L};
    int i;
    for (g_3[6] = 3; (g_3[6] >= 0); g_3[6] -= 1)
    { /* block id: 3 */
        int32_t l_5 = 0xD8D13034L;
        g_8++;
    }
    return g_3[6];
}
