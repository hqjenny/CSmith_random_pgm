 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 4257.c
 * Seed:      3896635322
 */
...
static volatile int16_t g_7 = 0x3046L;/* VOLATILE GLOBAL g_7 */
static int32_t g_9[2] = {8L,8L};
static volatile int32_t g_10 = (-1L);/* VOLATILE GLOBAL g_10 */
static int16_t g_11 = 1L;
static uint8_t g_12 = 0x34L;
