 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 9508.c
 * Seed:      2158090378
 */
...
{ /* block id: 0 */
    int16_t l_3 = 0x9464L;
    int32_t l_8[1];
    int32_t l_11 = 0xADF1ADB2L;
    int i;
    for (i = 0; i < 1; i++)
        l_8[i] = 0x1551DA62L;
    l_3 &= (g_2 = (-10L));
    l_8[0] = func_4(g_2);
    g_12 &= (l_11 = (safe_mul_func_uint8_t_u_u(g_7, 0xA2L)));
    return l_3;
}
