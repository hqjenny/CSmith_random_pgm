 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 8610.c
 * Seed:      1870409745
 */
...
static int32_t g_10 = 0xE41B66BAL;
static volatile uint32_t g_11[3][3] = {{4294967295UL,4294967295UL,4294967295UL},{0UL,0UL,0UL},{4294967295UL,4294967295UL,4294967295UL}};
...
{ /* block id: 0 */
    ...
    int32_t l_7 = 0L;
    int32_t l_9 = (-1L);
    for (g_2 = 22; (g_2 == (-14)); g_2 = safe_sub_func_int16_t_s_s(g_2, 5))
    { /* block id: 3 */
        int32_t l_5 = 1L;
        return l_5;
    }
