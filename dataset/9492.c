 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 9492.c
 * Seed:      2142864036
 */
...
static uint16_t g_5[1][3] = {{65535UL,65535UL,65535UL}};
...
static uint32_t  func_1(void)
{ /* block id: 0 */
    uint32_t l_8 = 0x2E6E7F73L;
    int32_t l_10 = (-9L);
    g_2 &= 0x462D5E48L;
    g_5[0][1] = (safe_rshift_func_int16_t_s_u(g_2, 5));
    for (g_2 = 0; (g_2 >= 7); g_2 = safe_add_func_int16_t_s_s(g_2, 6))
    { /* block id: 5 */
        uint8_t l_9 = 1UL;
        l_8 |= g_2;
        if (l_9)
