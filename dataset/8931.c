 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 8931.c
 * Seed:      227443695
 */
...
static int32_t g_5 = 0x2BD7B1C2L;
...
static uint32_t  func_1(void)
{ /* block id: 0 */
    for (g_2 = 0; (g_2 > 14); g_2 = safe_add_func_uint8_t_u_u(g_2, 9))
    { /* block id: 3 */
        uint16_t l_8[4];
        int i;
        for (i = 0; i < 4; i++)
        ...
        if (g_2)
            break;
        for (g_5 = 0; (g_5 <= (-26)); g_5 = safe_sub_func_int32_t_s_s(g_5, 2))
        { /* block id: 7 */
            int8_t l_10 = 0x5EL;
