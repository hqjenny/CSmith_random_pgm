 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 3819.c
 * Seed:      3451204246
 */
...
static int32_t g_6 = 0x654FDDD3L;
static volatile uint16_t g_8 = 0xCC58L;/* VOLATILE GLOBAL g_8 */
...
{ /* block id: 0 */
    ...
    for (g_2 = 2; (g_2 < 13); g_2 = safe_add_func_int32_t_s_s(g_2, 2))
    { /* block id: 3 */
        int32_t l_5[4][2];
        int i, j;
        for (i = 0; i < 4; i++)
