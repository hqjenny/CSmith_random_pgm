 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 2810.c
 * Seed:      172443985
 */
...
static volatile int32_t g_4[3] = {7L,7L,7L};
...
{ /* block id: 0 */
    ...
    for (i = 0; i < 10; i++)
        l_11[i] = 0xAAD8L;
    for (g_5 = (-15); (g_5 > (-18)); g_5 = safe_sub_func_int16_t_s_s(g_5, 8))
    { /* block id: 3 */
        g_3 = 0x0BE4438BL;
