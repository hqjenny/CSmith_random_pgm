 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 12069.c
 * Seed:      1709264038
 */
...
static int32_t  func_1(void)
{ /* block id: 0 */
    int16_t l_7[3][4] = {{0x55B7L,0x62C9L,0x196AL,0x196AL},{0L,0L,0x55B7L,0x196AL},{0xD19AL,0x62C9L,0xD19AL,0x55B7L}};
    int i, j;
    for (g_4 = 0; (g_4 <= 7); g_4 = safe_add_func_int16_t_s_s(g_4, 8))
    { /* block id: 3 */
