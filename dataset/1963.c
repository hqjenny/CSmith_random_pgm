 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 1963.c
 * Seed:      1388588784
 */
...
static volatile int32_t g_3 = 0x42EB90DAL;/* VOLATILE GLOBAL g_3 */
static volatile int32_t g_4 = 7L;/* VOLATILE GLOBAL g_4 */
static volatile int32_t g_5 = (-1L);/* VOLATILE GLOBAL g_5 */
static int32_t g_6 = 0xECF54C3CL;
static uint32_t g_13[1] = {18446744073709551615UL};
...
{ /* block id: 0 */
    uint32_t l_9 = 0UL;
    int32_t l_16 = 0x05B2906CL;
    for (g_6 = 0; (g_6 == (-25)); g_6 = safe_sub_func_int32_t_s_s(g_6, 9))
    { /* block id: 3 */
        uint8_t l_10 = 6UL;
        l_10 = l_9;
    }
    l_16 ^= (safe_div_func_uint8_t_u_u((g_13[0]++), l_9));
    return g_13[0];
}
