 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 3260.c
 * Seed:      2246688226
 */
...
/* ------------------------------------------ */
/* 
 * reads : g_4 g_5 g_8 g_2
 * writes: g_4 g_5 g_8
 */
static uint32_t  func_1(void)
{ /* block id: 0 */
    uint16_t l_12[9] = {0xC921L,0xC921L,0xC921L,0xC921L,0xC921L,0xC921L,0xC921L,0xC921L,0xC921L};
    int32_t l_15 = (-1L);
    uint8_t l_16 = 0UL;
    int i;
