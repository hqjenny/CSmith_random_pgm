 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 7458.c
 * Seed:      214360042
 */
...
static volatile uint16_t g_9[8] = {65529UL,65529UL,65529UL,65529UL,65529UL,65529UL,65529UL,65529UL};
...
lbl_12:
    for (g_3 = 0; (g_3 >= 8); g_3++)
    { /* block id: 3 */
        int32_t l_6 = 0xC17633EFL;
        int32_t l_7 = 0xF759609CL;
        int32_t l_8 = 1L;
        g_9[6]--;
    }
    if ((g_2 , 0xE672CA3CL))
