 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 11858.c
 * Seed:      2657233920
 */
...
static volatile int32_t g_7 = 0xAAEB9AE7L;/* VOLATILE GLOBAL g_7 */
