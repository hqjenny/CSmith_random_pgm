 ...
 * Git version: dcef523
 * Options:   --no-structs --no-pointers --no-math64 --max-funcs 4 --no-unions --output 7856.c
 * Seed:      3336398946
 */
...
{ /* block id: 0 */
    int16_t l_6 = 3L;
    int32_t l_7 = 0L;
    int32_t l_8 = 0x8AFA2FAFL;
    int32_t l_9 = 0x58A835A2L;
    ...
    --l_12;
    g_18 ^= ((safe_mod_func_int16_t_s_s(g_2[2], (+g_3))) ^ g_3);
    return g_2[1];
}
